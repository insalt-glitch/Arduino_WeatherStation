...
void sendOwnData(char* ownData, uint8_t len);
...
const char DA_label[] PROGMEM="DA";
const char MA_label[] PROGMEM="MA";
const char AC_label[] PROGMEM="AC";
const char PA_label[] PROGMEM="PA";
const char TH_label[] PROGMEM="TH";
const char BD_label[] PROGMEM="BD";
const char MD_label[] PROGMEM="MD";
const char FV_label[] PROGMEM="FV";
const char HV_label[] PROGMEM="HV";
const char RS_label[] PROGMEM="RS";
const char CF_label[] PROGMEM="CF";
const char OF_label[] PROGMEM="OF";
const char O0_label[] PROGMEM="O0";
const char SL_label[] PROGMEM="SL";
...
const AT_Command_t atCommands[] PROGMEM =
{
// Addressing:
...
const char error_1[] PROGMEM="received invalid RF data size";
const char error_2[] PROGMEM="received invalid RF data";
const char error_3[] PROGMEM="RX buffer overflow";
const char error_4[] PROGMEM="CRC check failed";

const char error_codes[] PROGMEM={
  error_0,
  error_1,
  error_2,
  error_3,
